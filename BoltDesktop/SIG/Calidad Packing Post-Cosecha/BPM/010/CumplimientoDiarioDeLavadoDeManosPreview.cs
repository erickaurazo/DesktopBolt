...
namespace ComparativoHorasVisualSATNISIRA.Calidad.ReportesCalidadPostCosecha.BPM._010
{
    public partial class CumplimientoDiarioDeLavadoDeManosPreview : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ListadoLavadoDeManoBySemanaPeriodoRPTTableAdapter adaptador;
        ...
        public CumplimientoDiarioDeLavadoDeManosPreview(string _conexion, SAS_ListadoLavadoDeManoAllByDatesResult _item)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ListadoLavadoDeManoBySemanaPeriodoRPTTableAdapter();
