...
namespace ComparativoHorasVisualSATNISIRA.Calidad.ReportesCalidadPostCosecha.BPM._013
{
    public partial class AmonestacionesIncumplimientoDeBuenasPracticasPackingPreview : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ListadoAmonestacionesIncumplimientosByIdTableAdapter adaptador;
        ...
        public AmonestacionesIncumplimientoDeBuenasPracticasPackingPreview(string _conexion, SAS_ListadoAmonestacionesIncumplimientosByDatesResult _item)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ListadoAmonestacionesIncumplimientosByIdTableAdapter();
