...
namespace ComparativoHorasVisualSATNISIRA.Calidad.ReportesCalidadPostCosecha.BPM._014
{
    public partial class CheckListBuenasPractivasManufacturaPreview : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ListadoCheckListBuenasPracticasManufacturaAllByWeekPeriodoTableAdapter adaptador;
        ...
        public CheckListBuenasPractivasManufacturaPreview(string _conexion, SAS_ListadoCheckListManufacturaAllByDatesResult _item)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ListadoCheckListBuenasPracticasManufacturaAllByWeekPeriodoTableAdapter();
