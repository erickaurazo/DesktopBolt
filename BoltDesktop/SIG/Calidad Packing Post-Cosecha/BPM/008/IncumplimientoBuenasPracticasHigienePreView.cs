...
namespace ComparativoHorasVisualSATNISIRA.Calidad.ReportesCalidadPostCosecha
{
    public partial class IncumplimientoBuenasPracticasHigieneView : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ReporteIncumplimientoPracticasHigieneByIdTableAdapter adaptador;
        ...
        public IncumplimientoBuenasPracticasHigieneView(string _conexion, int _codigo)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ReporteIncumplimientoPracticasHigieneByIdTableAdapter();
