...
{
    public partial class TipoGrupoMaestrosDespacho : Form
    {
        private int periodo;
        private SAS_USUARIOS user;
        private SAS_USUARIOS userLogin;
        private PrivilegesByUser privilege;
        private SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleMaestrosTipo selectedItem;
        private List<SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleMaestrosTipo> resultList;
        SAS_TipoMaestroCalidadController model;
        SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleMaestrosTipo itemRegistar;
        SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleMaestrosTipo itemDelete;
        ...
        public TipoGrupoMaestrosDespacho()
        {
            InitializeComponent();
            connection = "SAS";
        ...
        private void TipoGrupoMaestros_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.bgwHilo.IsBusy == true)
            {
                e.Cancel = true;
        ...
        private void dgvRegistro_SelectionChanged(object sender, EventArgs e)
        {
            ...
            selectedItem = new SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleMaestrosTipo();
            selectedItem.Id = 0;
        ...
        private void TipoGrupoMaestros_Load(object sender, EventArgs e)
        {
        ...
        private void EjecuarConsultaAsincrona()
        {
            ...
            try
            {
                ...
                resultList = new List<SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleMaestrosTipo>();
                model = new SAS_TipoMaestroCalidadController();
