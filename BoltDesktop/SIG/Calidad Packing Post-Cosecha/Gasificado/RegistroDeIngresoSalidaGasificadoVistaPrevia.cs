...
namespace ComparativoHorasVisualSATNISIRA.Calidad
{
    public partial class RegistroDeIngresoSalidaGasificadoVistaPrevia : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_RegistroGasificadoAllByDatesTableAdapter adaptador;
        ...
        public RegistroDeIngresoSalidaGasificadoVistaPrevia(string _conexion, string _desde, string _hasta)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_RegistroGasificadoAllByDatesTableAdapter();
