...
using ComparativoHorasVisualSATNISIRA.SIG.Calidad_Packing_Post_Cosecha.Gasificado;
...
namespace ComparativoHorasVisualSATNISIRA.Calidad.CalidadPackingPostCosecha.Frio_y_Despacho._023
{
    public partial class TrazabilidadDeContenedorDespachosPreView : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleCargaByIdTableAdapter adaptador;
        ...
        public TrazabilidadDeContenedorDespachosPreView(string _conexion, int _IdEvaluacion)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_Calidad_Form_EvaluacionTrazabilidadFCLDespachoDetalleCargaByIdTableAdapter();
