...
namespace ComparativoHorasVisualSATNISIRA.Calidad.CalidadPackingPostCosecha.Frio_y_Despacho._045
{
    public partial class ChecklistRevisionDelContenedorPreview : Form
    {
        ...
        private SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ReporteCheckListRevisionByIdEvaluacionTableAdapter adaptador;
        ...
        public ChecklistRevisionDelContenedorPreview(string _conexion, int _IdEvaluacion)
        {
            ...
            try
            {
                ...
                adaptador = new SIG.Calidad_Packing_Post_Cosecha.Gasificado.RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_ReporteCheckListRevisionByIdEvaluacionTableAdapter();
