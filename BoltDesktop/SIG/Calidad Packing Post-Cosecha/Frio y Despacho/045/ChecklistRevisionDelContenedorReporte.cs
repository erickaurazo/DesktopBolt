...
{
    public partial class ChecklistRevisionDelContenedorReporte : Form
    {
        #region Variables()  
        private int periodo;
        ...
        private SAS_Calidad_Form_CheckListTrazabilidadFCLDespachoController modelRevision;
        ...
        public ChecklistRevisionDelContenedorReporte()
        {
            InitializeComponent();
        ...
        public ChecklistRevisionDelContenedorReporte(string _conection, SAS_USUARIOS _user, string _companyId, PrivilegesByUser _privilege)
        {
            InitializeComponent();
            selectedItem = new SAS_EvaluacionTrazabilidadFCLDespachoResult();
            selectedItem.Id = 0;
        ...
        private void ChecklistRevisionDelContenedorReporte_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.bgwHilo.IsBusy == true)
            {
                e.Cancel = true;
        ...
        private void VistaPrevia(int Id)
        {
            if (Id != 0)
            {
                ChecklistRevisionDelContenedorPreview ofrm = new ChecklistRevisionDelContenedorPreview(conection, Id);
                ofrm.Show();
            }
        }
        ...
        private void btnAprobacionEvaluacionSub_Click_1(object sender, EventArgs e)
        {
            CambiarEstadoDeEvaluacion();
        }

        private void btnAprobacionDistribucionSub_Click_1(object sender, EventArgs e)
        {
            CambiarEstadoDeDistribucion();
        }

        private void btnAprobacionRevisionSub_Click_1(object sender, EventArgs e)
        {
            CambiarEstadoDeRevision();
        }
