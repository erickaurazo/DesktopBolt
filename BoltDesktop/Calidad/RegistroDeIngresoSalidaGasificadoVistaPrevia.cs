...
namespace ComparativoHorasVisualSATNISIRA.Calidad
{
    public partial class RegistroDeIngresoSalidaGasificadoVistaPrevia : Form
    {
        ...
        private RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_RegistroGasificadoAllByDatesTableAdapter adaptador;
        ...
        public RegistroDeIngresoSalidaGasificadoVistaPrevia(string _conexion, string _desde, string _hasta)
        {
            ...
            try
            {
                ...
                adaptador = new RegistroDeIngresoSalidaGasificadoDSTableAdapters.SAS_RegistroGasificadoAllByDatesTableAdapter();
