...
{
    public partial class CumplimientoDiarioDeLavadoDeManosReporte : Form
    {
        ...
        private SAS_ListadoLavadoDeManoAllByDatesResult selectedItem;
        private List<SAS_ListadoLavadoDeManoAllByDatesResult> resultList;
        ...
        public CumplimientoDiarioDeLavadoDeManosReporte()
        {
            InitializeComponent();
            connection = "SAS";
        ...
        public CumplimientoDiarioDeLavadoDeManosReporte(string _connection, SAS_USUARIOS _userLogin, string _companyId, PrivilegesByUser _privilege)
        {
            InitializeComponent();
        ...
        private void dgvRegistro_SelectionChanged(object sender, EventArgs e)
        {
            ...
            selectedItem = new SAS_ListadoLavadoDeManoAllByDatesResult();
        ...
        private void CumplimientoDiarioDeLavadoDeManosReporte_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.bgwHilo.IsBusy == true)
            {
                e.Cancel = true;
        ...
        private void EjecutarConsultaAsincrona()
        {
            try
            {
                resultList = new List<SAS_ListadoLavadoDeManoAllByDatesResult>();
                model = new SAS_FormatosDeInspeccionCalidadPacking();
                resultList = model.ListReporteCumplimientoDiarioDeLavadoDeManosReporte(connection, PeriodoDesde, PeriodoHasta, resumido);
            }
            catch (Exception Ex)
            {
                MessageBox.Show(Ex.Message.ToString(), "MENSAJE DEL SISTEMA");
        ...
        private void CumplimientoDiarioDeLavadoDeManosReporte_Load(object sender, EventArgs e)
        {
