...
{
    public partial class ProductosImpresionCodigoQR : Form
    {
        ...
        public ProductosImpresionCodigoQR()
        {
            InitializeComponent();
        }

        public ProductosImpresionCodigoQR(string codigo)
        {
            #region 
            InitializeComponent();
            _correlativo = codigo;

            this.crImpresionQR.PrintReport();
            try
            {
               ...
               oRpt.Load(@"C:\SOLUTION\ProductoImpresionCodigoBarraRPT.rpt");
                ...
                crImpresionQR.ReportSource = oRpt;
            }
            catch (Exception Ex)
            {
