...
{
    public partial class TipoSolicitudEquipamientoTecnologico : Form
    {
        ...
        public TipoSolicitudEquipamientoTecnologico()
        {
            InitializeComponent();
        }

        public TipoSolicitudEquipamientoTecnologico(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser privilege)
        {
            InitializeComponent();
            Inicio();
        ...
        private void TipoSolicitudEquipamientoTecnologico_Load(object sender, EventArgs e)
        {
