...
{
    public partial class ReportesListadoCaracteristicasPorDispositivos : Form
    {
        private int esAgrupado;
        private List<SAS_ListadoHardwareByDevice> listado;
        private SAS_DispostivoController modelo;
        private string _conection;
        private SAS_USUARIOS _user2;
        private string _companyId;
        private PrivilegesByUser privilege;
        private SAS_ListadoHardwareByDevice odetalleSelecionado;
        private string fileName;
        private bool exportVisualSettings;
        private int codigoDispotivo = 0;
        private SAS_DispositivoUsuariosController modeloUsuario;

        public ReportesListadoCaracteristicasPorDispositivos()
        {
            InitializeComponent();
        }

        public ReportesListadoCaracteristicasPorDispositivos(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser privilege)
        {
            InitializeComponent();
        ...
        private void ReportesListadoCaracteristicasPorDispositivos_Load(object sender, EventArgs e)
        {
        ...
        private void bgwHilo_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                listado = new List<SAS_ListadoHardwareByDevice>();
                listado = modelo.GetListHardwareAllDevice("SAS");
            }
            catch (Exception Ex)
            {
        ...
        private void bgwHilo_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                dgvListado.DataSource = listado.ToDataTable<SAS_ListadoHardwareByDevice>();
                dgvListado.Refresh();
                btnMenu.Enabled = true;
                gbList.Enabled = true;
                progressBar1.Visible = !true;
        ...
        private void ReportesListadoCaracteristicasPorDispositivos_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.bgwHilo.IsBusy == true)
            {
                e.Cancel = true;
        ...
        private void dgvListado_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                #region 
                odetalleSelecionado = new SAS_ListadoHardwareByDevice();
        ...
        private void IrADispositivo()
        {
            if (codigoDispotivo > 0)
            {
                ...
                oFron.MdiParent = ReportesListadoCaracteristicasPorDispositivos.ActiveForm;
