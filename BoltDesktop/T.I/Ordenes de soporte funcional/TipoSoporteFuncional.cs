...
using ComparativoHorasVisualSATNISIRA.T.I.Ordenes_de_soporte_funcional;

namespace ComparativoHorasVisualSATNISIRA.T.I
{
    public partial class TipoSoporteFuncional : Form
    {
        ...
        private List<SAS_DispositivoTipoSoporteFuncional> listadoAll;
        private SAS_DispositivoTipoSoporteFuncional itemSelecionado, itemARegistrar;
        private List<SAS_DispositivoTipoSoporteFuncionalDetalle> listadoDetalleByItemRegistrar, listadoDetalleByItemEliminar;
        private List<SAS_DispositivoTipoSoporteFuncionalDetalleByIdCodigoResult> listadoDetalleByItem;
        private string result;
        private int lastItem = 1;
        private string msgError = string.Empty;

        public TipoSoporteFuncional()
        {
            InitializeComponent();
            Inicio();
        ...
        public TipoSoporteFuncional(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser _privilege)
        {
            InitializeComponent();
            Inicio();
            RadGridLocalizationProvider.CurrentProvider = new Asistencia.ClaseTelerik.GridLocalizationProviderEspanol();
        ...
        private void TipoSoporteFuncional_Load(object sender, EventArgs e)
        {
        ...
        private void bgwHilo_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                listadoAll = new List<SAS_DispositivoTipoSoporteFuncional>();
        ...
        private void bgwHilo_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                dgvRegistro.DataSource = listadoAll.OrderBy(x => x.descripcion).ToList().ToDataTable<SAS_DispositivoTipoSoporteFuncional>();
                dgvRegistro.Refresh();
        ...
        private void Nuevo()
        {
            try
            {
                itemARegistrar = new SAS_DispositivoTipoSoporteFuncional();
                itemARegistrar.estado = 1;
                itemARegistrar.codigo = string.Empty;

                itemSelecionado = new SAS_DispositivoTipoSoporteFuncional();
                itemSelecionado.estado = 1;
                itemSelecionado.codigo = string.Empty;
        ...
        private void TipoSoporteFuncional_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.bgwHilo.IsBusy == true)
            {
                e.Cancel = true;
                    ...
                    if (dgvRegistro.CurrentRow != null)
                    {
                        if (dgvRegistro.CurrentRow.Cells["chCodigo"].Value != null)
                        {
                            if (dgvRegistro.CurrentRow.Cells["chCodigo"].Value.ToString() != string.Empty)
                            {
                                ...
                                var resultado = listadoAll.Where(x => x.codigo == codigo).ToList();
                                if (resultado.ToList().Count == 1)
                                {
                                    itemSelecionado = resultado.ElementAt(0);
                                    itemSelecionado.codigo = codigo;
        ...
        private void AsingarObjeto(SAS_DispositivoTipoSoporteFuncional oDetalle)
        {
            try
            {
                this.txtCodigo.Text = oDetalle.codigo != null ? oDetalle.codigo.ToString().Trim() : string.Empty;
                ...
                listadoDetalleByItem = new List<SAS_DispositivoTipoSoporteFuncionalDetalleByIdCodigoResult>();
                modelo = new SAS_DispositivoTipoSoporteFuncionalController();
                listadoDetalleByItem = modelo.GetToListDetail(conection, oDetalle).ToList();
                ...
                dgvDetail.CargarDatos(listadoDetalleByItem.ToDataTable<SAS_DispositivoTipoSoporteFuncionalDetalleByIdCodigoResult>());
                dgvDetail.Refresh();
        ...
        private void Grabar()
        {
            try
            {
                try
                {
                    ...
                    itemARegistrar = new SAS_DispositivoTipoSoporteFuncional();
                    itemARegistrar.codigo = (this.txtCodigo.Text).Trim();
                    ...
                    listadoDetalleByItemRegistrar = new List<SAS_DispositivoTipoSoporteFuncionalDetalle>();
                            ...
                            foreach (DataGridViewRow fila in this.dgvDetail.Rows)
                            {
                                if (fila.Cells["chcodigo"].Value.ToString().Trim() != String.Empty)
                                {
                                    try
                                    {
                                        ...
                                        SAS_DispositivoTipoSoporteFuncionalDetalle detailForItem = new SAS_DispositivoTipoSoporteFuncionalDetalle();
                                        ...
                                        detailForItem.idtipoSoftware = fila.Cells["chTipoSoftwareCodigo"].Value != null ? Convert.ToInt32(fila.Cells["chTipoSoftwareCodigo"].Value) : 0;
                ...
                listadoDetalleByItemRegistrar = new List<SAS_DispositivoTipoSoporteFuncionalDetalle>();
                listadoDetalleByItemEliminar = new List<SAS_DispositivoTipoSoporteFuncionalDetalle>();
                lastItem = 0;
                Consultar();
            }
            catch (Exception Ex)
        ...
        {
            if (this.txtTipoSoftwareCodigo.Text.Trim() != string.Empty && this.txtTipoSoftware.Text.Trim() != string.Empty)
            {
                Additem();
            }
            else
        ...
        private void Additem()
        {
            try
            {
                ...
                if (dgvDetail != null)
                {
                    ...
                    array.Add(this.txtTipoSoftwareCodigo.Text.Trim()); // chTipoSoftware                    
                    //array.Add(Convert.ToInt32(this.txtTipoSoftwareCodigo.Text.Trim())); // chTipoSoftware                    
                    array.Add(this.txtTipoSoftware.Text.Trim()); // tipoSoftware                    
                        ...
                        try
                        {
                            ...
                            if (codigo != null)
                            {
                                ...
                                if (codigo != null && itemIP != null)
                                {
                                    ...
                                    listadoDetalleByItemEliminar.Add(new SAS_DispositivoTipoSoporteFuncionalDetalle
                                    {
                                        codigo = codigo,
                                        item = itemIP,
                                    });
        ...
        private void Limpiar()
        {
            ...
            try
            {
                ...
                this.txtTipoSoftware.Clear();
                this.txtTipoSoftwareCodigo.Clear();
        ...
        private void btnVistaAgrupada_Click(object sender, EventArgs e)
        {
            ...
            {
                TipoSoporteFuncionalVistaAgrupada ofrm = new TipoSoporteFuncionalVistaAgrupada(conection, user2, companyId, privilege, codigoTipoSoporte);
                ofrm.ShowDialog();
            }
            else
            {
