...
{
    public partial class AtencionesSoporteFuncionalEdicionAsignarPrioridad : Form
    {
        ...
        public AtencionesSoporteFuncionalEdicionAsignarPrioridad()
        {
            InitializeComponent();
        }

        public AtencionesSoporteFuncionalEdicionAsignarPrioridad(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser _privilege, int _codigoSelecionado)
        {
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.txtCodigo.Text != string.Empty)
                {
                    ...
                    model = new SAS_DispositivoSoporteFuncionalController();
                    byte codigoPrioridad = Convert.ToByte(cboPrioridad.SelectedValue.ToString());
                    int resultadoOperacion = model.SetPriority(conection, codigoSelecionado, codigoPrioridad);
                    gbColaborador.Enabled = false;
                    gbReasignarCaso.Enabled = false;
        ...
        private void AtencionesSoporteFuncionalEdicionAsignarPrioridad_Load(object sender, EventArgs e)
        {
