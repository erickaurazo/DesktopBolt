...
{
    public partial class OrdenDeTrabajoITEdicionAsignarPrioridad : Form
    {
        ...
        public OrdenDeTrabajoITEdicionAsignarPrioridad()
        {
            InitializeComponent();
        }
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int resultadoRegistro = model.SetPriority("SAS", ordenTrabajo);
        ...
        public OrdenDeTrabajoITEdicionAsignarPrioridad(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser _privilege, int _codigoSelecionado)
        {
            InitializeComponent();
        ...
        private void OrdenDeTrabajoITEdicionAsignarPrioridad_Load(object sender, EventArgs e)
        {
