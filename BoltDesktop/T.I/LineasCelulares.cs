...
namespace ComparativoHorasVisualSATNISIRA.T.I
{
    public partial class LineasCelulares : Form
    {
        ...
        private string _lineaCelular = string.Empty;
        ...
        public LineasCelulares(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser privilege, string lineaCelular)
        {
            InitializeComponent();
            RadGridLocalizationProvider.CurrentProvider = new Asistencia.ClaseTelerik.GridLocalizationProviderEspanol();
            RadPageViewLocalizationProvider.CurrentProvider = new Asistencia.ClaseTelerik.RadPageViewLocalizationProviderEspañol();
        ...
        private void bgwHilo_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                if (_lineaCelular != null)
                {
                    if (_lineaCelular != string.Empty)
                    {
                        listado = modelo.ListOfCellLines("SAS", _lineaCelular);
                    }
                    else
                    {
