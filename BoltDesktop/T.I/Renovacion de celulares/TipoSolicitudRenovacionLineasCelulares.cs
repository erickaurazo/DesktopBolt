...
{
    public partial class TipoSolicitudRenovacionLineasCelulares : Form
    {
        ...
        public TipoSolicitudRenovacionLineasCelulares()
        {
            InitializeComponent();
        }


        public TipoSolicitudRenovacionLineasCelulares(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser privilege)
        {
            InitializeComponent();
            Inicio();
        ...
        private void TipoSolicitudRenovacionLineasCelulares_Load(object sender, EventArgs e)
        {
